...
# 编译更新服务为静态二进制文件
RUN CGO_ENABLED=0 GOOS=linux go build -ldflags="-s -w" -o pt-nexus-updater main.go
...
COPY --from=updater-builder /app/updater/pt-nexus-updater ./pt-nexus-updater
RUN chmod +x ./pt-nexus-updater
